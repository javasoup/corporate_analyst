...
from .tools import zoominfotool
...
*   You must deliver the final output as a visually rendered, well-formatted rich-text report. Do not deliver in raw markdown.
...
8.  Format Report:
    ...
    *   Include the 10-K report link.
    *   Add a concluding disclaimer.
9.  Render Final Markdown Report in a viewable format:
    *   Print the final output as a visually rendered, well-formatted rich-text report.
    *   Do NOT produce in JSON format.
""".strip(),
    children=[
